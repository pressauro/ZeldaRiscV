...
str: .string "penis mole"

.text
# a4 = 1 printa o mapa; a4 = 0 printa os boneco
SETUP:		
...
GAME_LOOP:	call KEY2			# chama o procedimento de entrada do teclado
		...
		#la t0, LINK_SPRITE
		#lw t0, (t0)
		#la a0,t0			# sprite do link dinamica
...
PRINT:		li t0,0xFF0			# carrega 0xFF0 em t0
		...
		li a6, 0			# contador largura max
		li a7, 0			# contador altura max
		li a5, 0			# contador 1 por 1
		bnez a4, PRINT_MAP
...
PRINT_MAP:
		...
		addi t3,t3,4			# incrementa contador de coluna
		blt t3,t4,PRINT_MAP		# se contador da coluna < largura, continue imprimindo
		...
		mv t3,zero			# zera t3 (contador de coluna)
		addi t2,t2,1			# incrementa contador de linha
		bgt t5,t2,PRINT_MAP		# se altura > contador de linha, continue imprimindo
		...
		mv t2,zero			# zera t2 (contador de linha)
